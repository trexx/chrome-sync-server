...
class PrinterPPDReference : public ::google::protobuf::MessageLite {
 public:
  ...
  PROTOBUF_DEPRECATED_ATTR bool has_effective_manufacturer() const;
  PROTOBUF_DEPRECATED_ATTR void clear_effective_manufacturer();
  PROTOBUF_DEPRECATED_ATTR static const int kEffectiveManufacturerFieldNumber = 2;
  PROTOBUF_DEPRECATED_ATTR const ::std::string& effective_manufacturer() const;
  PROTOBUF_DEPRECATED_ATTR void set_effective_manufacturer(const ::std::string& value);
  PROTOBUF_DEPRECATED_ATTR void set_effective_manufacturer(const char* value);
  PROTOBUF_DEPRECATED_ATTR void set_effective_manufacturer(const char* value, size_t size);
  PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_effective_manufacturer();
  PROTOBUF_DEPRECATED_ATTR ::std::string* release_effective_manufacturer();
  PROTOBUF_DEPRECATED_ATTR void set_allocated_effective_manufacturer(::std::string* effective_manufacturer);

  // optional string effective_model = 3 [deprecated = true];
  PROTOBUF_DEPRECATED_ATTR bool has_effective_model() const;
  PROTOBUF_DEPRECATED_ATTR void clear_effective_model();
  PROTOBUF_DEPRECATED_ATTR static const int kEffectiveModelFieldNumber = 3;
  PROTOBUF_DEPRECATED_ATTR const ::std::string& effective_model() const;
  PROTOBUF_DEPRECATED_ATTR void set_effective_model(const ::std::string& value);
  PROTOBUF_DEPRECATED_ATTR void set_effective_model(const char* value);
  PROTOBUF_DEPRECATED_ATTR void set_effective_model(const char* value, size_t size);
  PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_effective_model();
  PROTOBUF_DEPRECATED_ATTR ::std::string* release_effective_model();
  PROTOBUF_DEPRECATED_ATTR void set_allocated_effective_model(::std::string* effective_model);
 ...
 private:
  ...
  inline void set_has_effective_make_and_model();
  inline void clear_has_effective_make_and_model();
...
class PrinterSpecifics : public ::google::protobuf::MessageLite {
 ...
 private:
  ...
  inline void set_has_updated_timestamp();
  inline void clear_has_updated_timestamp();
...
inline const ::std::string& PrinterPPDReference::effective_make_and_model() const {
  ...
  return effective_make_and_model_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
