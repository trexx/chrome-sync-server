  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_card_class;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_card_billing_address_id;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_address_has_converted;
        break;
      }
