...
const PrinterPPDReference& PrinterPPDReference::default_instance() {
  ...
  protobuf_AddDesc_printer_5fspecifics_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_printer_5fspecifics_2eproto();
#endif
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_effective_manufacturer;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_effective_model;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_effective_make_and_model;
        break;
      }
      ...
      case 4: {
        if (tag == 34) {
         parse_effective_make_and_model:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_ppd;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_ppd_reference;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(80)) goto parse_updated_timestamp;
        break;
      }
