  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_deprecated_backup_timestamp;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_signin_scoped_device_id;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_last_updated_timestamp;
        break;
      }
