...
const ReadingListSpecifics& ReadingListSpecifics::default_instance() {
  ...
  protobuf_AddDesc_reading_5flist_5fspecifics_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_reading_5flist_5fspecifics_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(ReadingListSpecifics, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_update_time_us;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_first_read_time_us;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_update_title_time_us;
        break;
      }
