...
class SyncEnums : public ::google::protobuf::MessageLite {
 public:
  ...
  static const SingletonDebugEventType CONNECTION_STATUS_CHANGE =
    SyncEnums_SingletonDebugEventType_CONNECTION_STATUS_CHANGE;
  static const SingletonDebugEventType UPDATED_TOKEN =
    SyncEnums_SingletonDebugEventType_UPDATED_TOKEN;
  static const SingletonDebugEventType PASSPHRASE_REQUIRED =
    SyncEnums_SingletonDebugEventType_PASSPHRASE_REQUIRED;
  static const SingletonDebugEventType PASSPHRASE_ACCEPTED =
    SyncEnums_SingletonDebugEventType_PASSPHRASE_ACCEPTED;
  static const SingletonDebugEventType INITIALIZATION_COMPLETE =
    SyncEnums_SingletonDebugEventType_INITIALIZATION_COMPLETE;
  static const SingletonDebugEventType STOP_SYNCING_PERMANENTLY =
    SyncEnums_SingletonDebugEventType_STOP_SYNCING_PERMANENTLY;
  static const SingletonDebugEventType ENCRYPTION_COMPLETE =
    SyncEnums_SingletonDebugEventType_ENCRYPTION_COMPLETE;
  static const SingletonDebugEventType ACTIONABLE_ERROR =
    SyncEnums_SingletonDebugEventType_ACTIONABLE_ERROR;
  static const SingletonDebugEventType ENCRYPTED_TYPES_CHANGED =
    SyncEnums_SingletonDebugEventType_ENCRYPTED_TYPES_CHANGED;
  static const SingletonDebugEventType PASSPHRASE_TYPE_CHANGED =
    SyncEnums_SingletonDebugEventType_PASSPHRASE_TYPE_CHANGED;
  static const SingletonDebugEventType KEYSTORE_TOKEN_UPDATED =
    SyncEnums_SingletonDebugEventType_KEYSTORE_TOKEN_UPDATED;
  static const SingletonDebugEventType CONFIGURE_COMPLETE =
    SyncEnums_SingletonDebugEventType_CONFIGURE_COMPLETE;
  static const SingletonDebugEventType BOOTSTRAP_TOKEN_UPDATED =
  ...
  static const SingletonDebugEventType SingletonDebugEventType_MIN =
    SyncEnums_SingletonDebugEventType_SingletonDebugEventType_MIN;
  static const SingletonDebugEventType SingletonDebugEventType_MAX =
    SyncEnums_SingletonDebugEventType_SingletonDebugEventType_MAX;
  static const int SingletonDebugEventType_ARRAYSIZE =
    SyncEnums_SingletonDebugEventType_SingletonDebugEventType_ARRAYSIZE;

  typedef SyncEnums_PageTransition PageTransition;
  static const PageTransition LINK =
    SyncEnums_PageTransition_LINK;
  static const PageTransition TYPED =
    SyncEnums_PageTransition_TYPED;
  static const PageTransition AUTO_BOOKMARK =
    SyncEnums_PageTransition_AUTO_BOOKMARK;
  static const PageTransition AUTO_SUBFRAME =
    SyncEnums_PageTransition_AUTO_SUBFRAME;
  static const PageTransition MANUAL_SUBFRAME =
    SyncEnums_PageTransition_MANUAL_SUBFRAME;
  static const PageTransition GENERATED =
    SyncEnums_PageTransition_GENERATED;
  static const PageTransition AUTO_TOPLEVEL =
    SyncEnums_PageTransition_AUTO_TOPLEVEL;
  static const PageTransition FORM_SUBMIT =
    SyncEnums_PageTransition_FORM_SUBMIT;
  static const PageTransition RELOAD =
    SyncEnums_PageTransition_RELOAD;
  static const PageTransition KEYWORD =
    SyncEnums_PageTransition_KEYWORD;
  static const PageTransition KEYWORD_GENERATED =
  ...
  static const PageTransitionRedirectType CLIENT_REDIRECT =
    SyncEnums_PageTransitionRedirectType_CLIENT_REDIRECT;
  static const PageTransitionRedirectType SERVER_REDIRECT =
  ...
  static const PageTransitionRedirectType PageTransitionRedirectType_MIN =
    SyncEnums_PageTransitionRedirectType_PageTransitionRedirectType_MIN;
  static const PageTransitionRedirectType PageTransitionRedirectType_MAX =
    SyncEnums_PageTransitionRedirectType_PageTransitionRedirectType_MAX;
  static const int PageTransitionRedirectType_ARRAYSIZE =
    SyncEnums_PageTransitionRedirectType_PageTransitionRedirectType_ARRAYSIZE;

  typedef SyncEnums_ErrorType ErrorType;
  static const ErrorType SUCCESS =
    SyncEnums_ErrorType_SUCCESS;
  static const ErrorType DEPRECATED_ACCESS_DENIED =
    SyncEnums_ErrorType_DEPRECATED_ACCESS_DENIED;
  static const ErrorType NOT_MY_BIRTHDAY =
    SyncEnums_ErrorType_NOT_MY_BIRTHDAY;
  static const ErrorType THROTTLED =
    SyncEnums_ErrorType_THROTTLED;
  static const ErrorType DEPRECATED_AUTH_EXPIRED =
    SyncEnums_ErrorType_DEPRECATED_AUTH_EXPIRED;
  static const ErrorType DEPRECATED_USER_NOT_ACTIVATED =
    SyncEnums_ErrorType_DEPRECATED_USER_NOT_ACTIVATED;
  static const ErrorType DEPRECATED_AUTH_INVALID =
    SyncEnums_ErrorType_DEPRECATED_AUTH_INVALID;
  static const ErrorType CLEAR_PENDING =
    SyncEnums_ErrorType_CLEAR_PENDING;
  static const ErrorType TRANSIENT_ERROR =
    SyncEnums_ErrorType_TRANSIENT_ERROR;
  static const ErrorType MIGRATION_DONE =
    SyncEnums_ErrorType_MIGRATION_DONE;
  static const ErrorType DISABLED_BY_ADMIN =
    SyncEnums_ErrorType_DISABLED_BY_ADMIN;
  static const ErrorType DEPRECATED_USER_ROLLBACK =
    SyncEnums_ErrorType_DEPRECATED_USER_ROLLBACK;
  static const ErrorType PARTIAL_FAILURE =
    SyncEnums_ErrorType_PARTIAL_FAILURE;
  static const ErrorType CLIENT_DATA_OBSOLETE =
    SyncEnums_ErrorType_CLIENT_DATA_OBSOLETE;
  static const ErrorType UNKNOWN =
  ...
  static const Action UPGRADE_CLIENT =
    SyncEnums_Action_UPGRADE_CLIENT;
  static const Action CLEAR_USER_DATA_AND_RESYNC =
    SyncEnums_Action_CLEAR_USER_DATA_AND_RESYNC;
  static const Action ENABLE_SYNC_ON_ACCOUNT =
    SyncEnums_Action_ENABLE_SYNC_ON_ACCOUNT;
  static const Action STOP_AND_RESTART_SYNC =
    SyncEnums_Action_STOP_AND_RESTART_SYNC;
  static const Action DISABLE_SYNC_ON_CLIENT =
    SyncEnums_Action_DISABLE_SYNC_ON_CLIENT;
  static const Action UNKNOWN_ACTION =
  ...
  static const DeviceType TYPE_WIN =
    SyncEnums_DeviceType_TYPE_WIN;
  static const DeviceType TYPE_MAC =
    SyncEnums_DeviceType_TYPE_MAC;
  static const DeviceType TYPE_LINUX =
    SyncEnums_DeviceType_TYPE_LINUX;
  static const DeviceType TYPE_CROS =
    SyncEnums_DeviceType_TYPE_CROS;
  static const DeviceType TYPE_OTHER =
    SyncEnums_DeviceType_TYPE_OTHER;
  static const DeviceType TYPE_PHONE =
    SyncEnums_DeviceType_TYPE_PHONE;
  static const DeviceType TYPE_TABLET =
  ...
  static const GetUpdatesOrigin UNKNOWN_ORIGIN =
    SyncEnums_GetUpdatesOrigin_UNKNOWN_ORIGIN;
  static const GetUpdatesOrigin PERIODIC =
    SyncEnums_GetUpdatesOrigin_PERIODIC;
  static const GetUpdatesOrigin NEWLY_SUPPORTED_DATATYPE =
    SyncEnums_GetUpdatesOrigin_NEWLY_SUPPORTED_DATATYPE;
  static const GetUpdatesOrigin MIGRATION =
    SyncEnums_GetUpdatesOrigin_MIGRATION;
  static const GetUpdatesOrigin NEW_CLIENT =
    SyncEnums_GetUpdatesOrigin_NEW_CLIENT;
  static const GetUpdatesOrigin RECONFIGURATION =
    SyncEnums_GetUpdatesOrigin_RECONFIGURATION;
  static const GetUpdatesOrigin GU_TRIGGER =
    SyncEnums_GetUpdatesOrigin_GU_TRIGGER;
  static const GetUpdatesOrigin RETRY =
    SyncEnums_GetUpdatesOrigin_RETRY;
  static const GetUpdatesOrigin PROGRAMMATIC =
  ...
  static const GetUpdatesOrigin GetUpdatesOrigin_MIN =
    SyncEnums_GetUpdatesOrigin_GetUpdatesOrigin_MIN;
  static const GetUpdatesOrigin GetUpdatesOrigin_MAX =
    SyncEnums_GetUpdatesOrigin_GetUpdatesOrigin_MAX;
  static const int GetUpdatesOrigin_ARRAYSIZE =
...
template <> struct is_proto_enum< ::sync_pb::SyncEnums_SingletonDebugEventType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::sync_pb::SyncEnums_PageTransition> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::sync_pb::SyncEnums_PageTransitionRedirectType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::sync_pb::SyncEnums_ErrorType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::sync_pb::SyncEnums_Action> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::sync_pb::SyncEnums_DeviceType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::sync_pb::SyncEnums_GetUpdatesOrigin> : ::google::protobuf::internal::true_type {};
