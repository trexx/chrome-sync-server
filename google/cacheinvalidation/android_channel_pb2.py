...
_MAJORVERSION.has_options = True
_MAJORVERSION._options = _descriptor._ParseOptions(descriptor_pb2.EnumOptions(), _b('\020\001'))
_ENDPOINTID.fields_by_name['sender_id'].has_options = True
_ENDPOINTID.fields_by_name['sender_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
